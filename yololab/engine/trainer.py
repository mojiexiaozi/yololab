...
from yololab.nn.utils import attempt_load_one_weight, attempt_load_weights
...
from yololab.utils.autobatch import check_train_batch_size
...
from yololab.utils.dist import ddp_cleanup, generate_ddp_command
from yololab.utils.files import get_latest_run
...
class BaseTrainer:
        ...
        for k, v in self.model.named_parameters():
            ...
            if any(x in k for x in freeze_layer_names):
                ...
                LOGGER.info(
                    ...
                    "See yololab.engine.trainer for customization of frozen layers."
                )
    ...
    def save_model(self):
        ...
        ckpt = {
            ...
            "version": __version__,
            "license": "AGPL-3.0 (https://yololab.com/license)",
        ...
        if resume:
            try:
                ...
                for k in (
                    "imgsz",
                    "batch",
                ):  # allow arg updates to reduce memory on resume if crashed due to CUDA OOM
                    if k in overrides:
    ...
    def build_optimizer(
        ...
        if name in ("Adam", "Adamax", "AdamW", "NAdam", "RAdam"):
            ...
            raise NotImplementedError(
                ...
                "To request support for addition optimizers please visit https://github.com/yololab/yololab."
            )
