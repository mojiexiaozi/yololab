...
from yololab.data import load_inference_source
from yololab.data.augment import LetterBox, classify_transforms
from yololab.nn.autobackend import AutoBackend
from yololab.utils import DEFAULT_CFG, LOGGER, MACOS, WINDOWS, callbacks, colorstr, ops
from yololab.utils.checks import check_imgsz, check_imshow
from yololab.utils.files import increment_path
from yololab.utils.torch_utils import select_device, smart_inference_mode

STREAM_WARNING = """
WARNING ⚠️ inference results will accumulate in RAM unless `stream=True` is passed, causing potential out-of-memory
errors for large sources or long-running streams and videos. See https://docs.yololab.com/modes/predict/ for help.
