...
from yololab.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, __version__
from yololab.utils.checks import PYTHON_VERSION, check_version
...
def select_device(device="", batch=0, newline=False, verbose=True):
    ...
    s = f"yololab YOLOv{__version__} 🚀 Python-{PYTHON_VERSION} torch-{torch.__version__} "
