...
Usage:
    from yololab.utils.benchmarks import ProfileModels, benchmark
...
from yololab import YOLO, YOLOWorld
from yololab.cfg import TASK2DATA, TASK2METRIC
from yololab.engine.exporter import export_formats
from yololab.utils import ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from yololab.utils.checks import IS_PYTHON_3_12, check_requirements, check_yolo
from yololab.utils.files import file_size
    ...
    for i, (
        ...
        try:
            ...
            if i in {3, 5}:  # CoreML and OpenVINO
                assert (
                    not IS_PYTHON_3_12
                ), "CoreML and OpenVINO not supported on Python 3.12"
...
class ProfileModels:
    ...
    Example:
        ```python
        from yololab.utils.benchmarks import ProfileModels
