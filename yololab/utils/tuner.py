...
from yololab.cfg import TASK2DATA, TASK2METRIC, get_save_dir
from yololab.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, NUM_THREADS
...
def run_ray_tune(
    ...
    **train_args,
    ...
    LOGGER.info(
        "💡 Learn about RayTune at https://docs.yololab.com/integrations/ray-tune"
    )
    ...
    try:
        ...
        raise ModuleNotFoundError(
            'Tuning hyperparameters requires Ray Tune. Install with: pip install "ray[tune]"'
        )
