...
from yololab.utils.metrics import OKS_SIGMA
from yololab.utils.ops import crop_mask, xywh2xyxy, xyxy2xywh
from yololab.utils.tal import (
    ...
    def forward(
        ...
        if self.use_dfl:
            target_ltrb = bbox2dist(
                anchor_points, xywh2xyxy(target_bboxes[..., :4]), self.reg_max
            )
            loss_dfl = (
                self._df_loss(
                    pred_dist[fg_mask].view(-1, self.reg_max + 1), target_ltrb[fg_mask]
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError(
                ...
                "as an example.\nSee https://docs.yololab.com/datasets/segment/ for help."
            ) from e
...
class v8OBBLoss(v8DetectionLoss):
    def __init__(self, model):
        ...
        self.bbox_loss = RotatedBboxLoss(self.reg_max - 1, use_dfl=self.use_dfl).to(
            self.device
        )
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError(
                ...
                "as an example.\nSee https://docs.yololab.com/datasets/obb/ for help."
            ) from e
