...
from yololab.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr

try:
    # WARNING: do not move SummaryWriter import due to protobuf bug https://github.com/yololab/yololab/pull/4674
    ...
    from yololab.utils.torch_utils import de_parallel, torch
...
def _log_tensorboard_graph(trainer):
    ...
    im = torch.zeros(
        (1, 3, *imgsz), device=p.device, dtype=p.dtype
    )  # input image (must be zeros, not empty)
