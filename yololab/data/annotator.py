...
def auto_annotate(
    ...
    Example:
        ```python
        from yololab.data.annotator import auto_annotate

        auto_annotate(data='yololab/assets', det_model='yolov8n.pt', sam_model='mobile_sam.pt')
        ```
    """
