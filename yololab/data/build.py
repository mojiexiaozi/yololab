...
from yololab.data.loaders import (
    LOADERS,
    LoadImages,
    LoadPilAndNumpy,
    LoadScreenshots,
...
from yololab.data.utils import IMG_FORMATS, VID_FORMATS
from yololab.utils import RANK, colorstr
from yololab.utils.checks import check_file
...
def check_source(source):
    ...
    if isinstance(source, (str, int, Path)):  # int for local usb camera
        ...
        raise TypeError(
            "Unsupported image type. For supported types see https://docs.yololab.com/modes/predict"
        )
